...
-  Mobile tests executed using **Appium** with a physical device
...
Includes **24 automated E2E tests** and **6 e2e tests for moobile** covering the complete user journey:
- Login  
- Product browsing  
